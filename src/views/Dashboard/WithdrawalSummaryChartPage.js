...
const tableHeaders = [
    ...
    {
        id: 2,
        value: 'today Withdrawal volume',
        range: 'today'
    },
    {
        id: 3,
        value: 'today Withdrawal value (Naira)',
        range: 'today'
    },
    {
        id: 4,
        value: 'today Withdrawal success volume',
        range: 'today'
    },
    {
        id: 5,
      ...
      <Card overflowX={{ sm: "scroll", xl: "hidden" }}>
        ...
        <Stack>
            <Text fontSize="xl" color={textColor} fontWeight="bold">
                {`Withdrawal (${formatCurrencyNumber(merchantSummaryCount)})`}
            </Text>
