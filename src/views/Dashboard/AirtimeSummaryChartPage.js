...
const tableHeaders = [
    ...
    {
        id: 2,
        value: 'today airtime volume',
        range: 'today'
    },
    {
        id: 3,
        value: 'todayairtimer value (Naira)',
        range: 'today'
    },
    {
        id: 4,
        value: 'today airtime success volume',
        range: 'today'
    },
    {
        id: 5,
        value: 'today airtime success value',
        range: 'today'
    },
    {
        id: 6,
        value: 'today airtime failed volume',
        range: 'today'
    },
    {
        id: 7,
        value: 'today airtime failed value',
        range: 'today'
    },
    {
        id: 8,
        value: 'last 30 days airtime volume',
        range: 'l30'
    },
    {
        id: 9,
        value: 'last 30 days airtime value (Naira)',
        range: 'l30'
    },
    {
        id: 10,
        value: 'last 30 days airtime success volume',
        range: 'l30'
    },
    {
        id: 11,
        value: 'last 30 days airtime success value (Naira)',
        range: 'l30'
    },
    {
        id: 12,
        value: 'last 30 days airtime failed volume',
        range: 'l30'
    },
    {
        id: 13,
        value: 'last 30 days airtime failed value (Naira)',
        range: 'l30'
    },
    {
        id: 14,
        value: 'all time airtime volume',
        range: 'allTime'
    },
    {
        id: 15,
        value: 'all time airtime value (Naira)',
        range: 'allTime',
    },
    {
        id: 16,
        value: 'all time airtime success volume',
        range: 'allTime',
    },
    {
        id: 17,
        value: 'all time airtime success value (Naira)',
        range: 'allTime',
    },
    {
        id: 18,
        value: 'all time airtime failed volume',
        range: 'allTime',
    },
    {
        id: 19,
        value: 'all time airtime failed value (Naira)',
        range: 'allTime',
    },
];
      ...
      <Card overflowX={{ sm: "scroll", xl: "hidden" }}>
        ...
        <Stack>
            <Text fontSize="xl" color={textColor} fontWeight="bold">
                {`Airtime Summary (${formatCurrencyNumber(merchantSummaryCount)})`}
            </Text>
