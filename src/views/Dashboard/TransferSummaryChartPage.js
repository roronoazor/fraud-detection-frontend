...
//dummy data
import { Transactions } from "variables/dummyData";
...
const tableHeaders = [
    ...
    {
        id: 2,
        value: 'today transfer volume',
        range: 'today'
    },
    {
        id: 3,
        value: 'today transfer value (Naira)',
        range: 'today'
    },
    {
        id: 4,
        value: 'today transfer success volume',
        range: 'today'
    },
    {
        id: 5,
        value: 'today transfer success value',
        range: 'today'
    },
    {
        id: 6,
        value: 'today transfer failed volume',
        range: 'today'
    },
    {
        id: 7,
        value: 'today transfer failed value',
        range: 'today'
    },
    {
        id: 8,
        value: 'last 30 days transfer volume',
        range: 'l30'
    },
    {
        id: 9,
        value: 'last 30 days transfer value (Naira)',
        range: 'l30'
    },
    {
        id: 10,
        value: 'last 30 days transfer success volume',
        range: 'l30'
    },
    {
        id: 11,
        value: 'last 30 days transfer success value (Naira)',
        range: 'l30'
    },
    {
        id: 12,
        value: 'last 30 days transfer failed volume',
        range: 'l30'
    },
    {
        id: 13,
        value: 'last 30 days transfer failed value (Naira)',
        range: 'l30'
    },
    {
        id: 14,
        value: 'all time transfer volume',
        range: 'allTime'
    },
    {
        id: 15,
        value: 'all time transfer value (Naira)',
        range: 'allTime',
    },
    {
        id: 16,
        value: 'all time transfer success volume',
        range: 'allTime',
    },
    {
        id: 17,
        value: 'all time transfer success value (Naira)',
        range: 'allTime',
    },
    {
        id: 18,
        value: 'all time transfer failed volume',
        range: 'allTime',
    },
    {
        id: 19,
        value: 'all time transfer failed value (Naira)',
        range: 'allTime',
    },
];
...
function Tables() {
    ...
    const [merchantSummaries, setMerchantSummaries] = useState(Transactions);
      ...
      <Card overflowX={{ sm: "scroll", xl: "hidden" }}>
        ...
        <Stack>
            <Text fontSize="xl" color={textColor} fontWeight="bold">
                {`Transfer Summary (${formatCurrencyNumber(merchantSummaryCount)})`}
            </Text>
